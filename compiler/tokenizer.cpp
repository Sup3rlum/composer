...
Token SourceStream::ReadToken()
{
	...
	if (IsLetter(currentChar))
	{
		...
		/* Match nay keywords */
		if		(buffer == "if")		return Token{ TokenType::KwIf, buffer };
		else if (buffer == "else")		return Token{ TokenType::KwElse, buffer };
		else if (buffer == "struct")	return Token{ TokenType::KwStruct, buffer };
		else if (buffer == "for")		return Token{ TokenType::KwFor, buffer };
		else if (buffer == "while")		return Token{ TokenType::KwWhile, buffer };
	...
	else 
	{
		...
		case '{': return Token{ TokenType::LCurly,		std::string{ currentChar } }; break;
		case ')': return Token{ TokenType::RParen,		std::string{ currentChar } }; break;
		case '>': return Token{ TokenType::RTriangle,	std::string{ currentChar } }; break;
		...
		case '-': return Token{ TokenType::OpMinus,		std::string{ currentChar } }; break;
		case '*': return Token{ TokenType::OpAsterisk,	std::string{ currentChar } }; break;
		case '/': return Token{ TokenType::OpSlash,		std::string{ currentChar } }; break;
		case '!': return Token{ TokenType::OpExcl,		std::string{ currentChar } }; break;
		case ',': return Token{ TokenType::OpComma,		std::string{ currentChar } }; break;
		case ';': return Token{ TokenType::OpSemicolon,	std::string{ currentChar } }; break;
		default:
			break;
		}
	}
