...
PResult<Number> Parser::ParseNumber(TokenStream& tokens)
{
	...
	if (hasSuffix)
	{
		if (suffix == "d" || suffix == "D") t = Number::Type::Float64;
		else if (suffix == "f" || suffix == "F") t = Number::Type::Float32;
		else if (suffix == "l" || suffix == "L") t = Number::Type::Int64;
		else if (suffix == "u" || suffix == "U") t = Number::Type::UInt32;
		else if (suffix == "ul" || suffix == "UL") t = Number::Type::UInt64;
	}
